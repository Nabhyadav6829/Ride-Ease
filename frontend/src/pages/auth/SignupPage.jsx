    ...
    try {
      ...
      if (res.ok) {
        ...
        if (onLogin) {
          ...
          // ***** FIX IS HERE *****
          // Add the `role` to the userData object before passing it to the onLogin handler.
          // This ensures App.jsx receives the correct role and doesn't default to 'driver'.
          onLogin({ ...userData, role: role }, data.token);
        } else {
        ...
        navigate(role === 'user' ? '/' : '/driver/home'); // Fixed navigation logic
      } else {
