...
//     if (token) {
//       try {
//         const endpoint = role === 'driver' ? '/api/drivers/me' : '/api/users/me';
...
//         />
//       </Routes>
//       {isRideActive && <RideStatusBanner details={rideDetails} onCancel={handleCancelRide} />}
//     </div>
//   );
// }
...
function AppContent() {
  ...
  const handleLogin = async (data, token) => {
    ...
    setIsLoggedIn(true);
    setUser(userData);
    await checkAuthStatus(); // Added to refresh user data immediately after login
    navigate(userData.role === 'driver' ? '/driver/home' : '/');
  };
